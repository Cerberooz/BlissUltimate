...
public class TraderSwapAdvancement extends BaseAdvancement {
  static final String TRADER_NAME_MARKER;

  public TraderSwapAdvancement(
      Bliss bliss,
      String text,
  ...
  void onPlayerInteract(PlayerInteractEvent event) {
    ...
    boolean enabled = this.isMatchingItem(mainHandItem) || this.isMatchingItem(offHandItem);
    if (enabled) {
  ...
  boolean isMatchingItem(ItemStack item) {
    ...
    return displayName != null && displayName.contains(TRADER_NAME_MARKER);
  }

  static {
    TRADER_NAME_MARKER = "ᴛʀᴀᴅᴇʀ";
  }
}
